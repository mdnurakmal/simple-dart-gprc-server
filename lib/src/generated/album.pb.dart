...
class Album extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('Album', createEmptyInstance: create)
  ...
  factory Album.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Album.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Album clone() => Album()..mergeFromMessage(this);
  Album copyWith(void Function(Album) updates) =>
      super.copyWith((message) => updates(message as Album));
...
class Photo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('Photo', createEmptyInstance: create)
...
class AlbumRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('AlbumRequest', createEmptyInstance: create)
        ..a<$core.int>(1, 'id', $pb.PbFieldType.O3)
        ..hasRequiredFields = false;

  AlbumRequest._() : super();
  factory AlbumRequest() => create();
  factory AlbumRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AlbumRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  AlbumRequest clone() => AlbumRequest()..mergeFromMessage(this);
  AlbumRequest copyWith(void Function(AlbumRequest) updates) =>
      super.copyWith((message) => updates(message as AlbumRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static AlbumRequest create() => AlbumRequest._();
  AlbumRequest createEmptyInstance() => create();
  static $pb.PbList<AlbumRequest> createRepeated() =>
      $pb.PbList<AlbumRequest>();
  @$core.pragma('dart2js:noInline')
  static AlbumRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AlbumRequest>(create);
...
class AlbumResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('AlbumResponse', createEmptyInstance: create)
        ..pc<Album>(1, 'albums', $pb.PbFieldType.PM, subBuilder: Album.create)
        ..hasRequiredFields = false;

  AlbumResponse._() : super();
  factory AlbumResponse() => create();
  factory AlbumResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AlbumResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  AlbumResponse clone() => AlbumResponse()..mergeFromMessage(this);
  AlbumResponse copyWith(void Function(AlbumResponse) updates) =>
      super.copyWith((message) => updates(message as AlbumResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static AlbumResponse create() => AlbumResponse._();
  AlbumResponse createEmptyInstance() => create();
  static $pb.PbList<AlbumResponse> createRepeated() =>
      $pb.PbList<AlbumResponse>();
  @$core.pragma('dart2js:noInline')
  static AlbumResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AlbumResponse>(create);
